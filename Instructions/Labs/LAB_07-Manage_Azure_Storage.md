...
1. InPrivate 브라우저 창을 닫고 Azure Storage 컨테이너의 **라이선스/LICENSE** 블레이드를 표시하는 브라우저 창으로 돌아가서 다시 **az104-07-container** 블레이드로 이동합니다.
...
1. **연결** 블레이드에서 **Windows** 탭이 선택되어 있는지 확인하고 **클립보드에 복사**를 클릭합니다.

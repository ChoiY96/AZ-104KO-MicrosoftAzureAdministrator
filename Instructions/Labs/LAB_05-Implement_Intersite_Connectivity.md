...
1. 다음 설정을 지정하고(나머지는 기본값으로 유지) **만들기**를 클릭합니다.

    | 설정 | 값|
    | --- | --- |
    | 해당 가상 네트워크: 피어링 링크 이름 | **az104-05-vnet0_to_az104-05-vnet1** |
    | 해당 가상 네트워크: 원격 가상 네트워크로의 트래픽 | **허용(기본값)** |
    | 해당 가상 네트워크: 원격 가상 네트워크에서 전달된 트래픽 | **해당 가상 네트워크 외부에서 발생한 트래픽 차단** |
    | 가상 네트워크 게이트웨이 | **없음** |
    ...
    | 원격 가상 네트워크에서 전달된 트래픽 | **해당 가상 네트워크 외부에서 발생한 트래픽 차단** |
    | 가상 네트워크 게이트웨이 | **없음** |
...
1. 다음 설정을 사용하여 피어링을 추가합니다.(다른 설정은 기본값으로 유지.)
    ...
    | 설정 | 값|
    | --- | --- |
    | 해당 가상 네트워크: 피어링 링크 이름 | **az104-05-vnet0_to_az104-05-vnet2** |
    | 해당 가상 네트워크: 원격 가상 네트워크로의 트래픽 | **허용(기본값)** |
    | 해당 가상 네트워크: 원격 가상 네트워크에서 전달된 트래픽 | **해당 가상 네트워크 외부에서 발생한 트래픽 차단** |
    | 가상 네트워크 게이트웨이 | **없음** |
...
1. 다음 설정을 사용하여 피어링을 추가합니다.(다른 설정은 기본값으로 유지.)
    ...
    | 설정 | 값|
    | --- | --- |
    | 해당 가상 네트워크: 피어링 링크 이름 | **az104-05-vnet1_to_az104-05-vnet2** |
    | 해당 가상 네트워크: 원격 가상 네트워크로의 트래픽 | **허용(기본값)** |
    | 해당 가상 네트워크: 원격 가상 네트워크에서 전달된 트래픽 | **해당 가상 네트워크 외부에서 발생한 트래픽 차단** |
    | 가상 네트워크 게이트웨이 | **없음** |

...
1. Azure Portal에서 **부하 분산 장치**를 검색 및 선택하고 부하 분산 장치 목록에서 **az10408vmss0lb**를 클릭합니다.

1. **az10408vmss0lb** 블레이드에서 부하 분산 장치의 프런트 엔드에 할당된 **공용 IP 주소**의 값을 기록하고 새 브라우저 탭을 열어 해당 IP 주소로 이동합니다.
...
1. Azure Portal의 **az10408vmss0** 블레이드에서 **크기**를 클릭합니다.

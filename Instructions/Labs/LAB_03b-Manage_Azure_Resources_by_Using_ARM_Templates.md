...
1. **Microsoft.ManagedDisk-*XXXXXXXXX* \| 개요** 블레이드에서 템플릿을 클릭합니다.
...
1. **매개 변수 편집** 블레이드에서 **파일 로드**를 클릭하고 이전 작업에서 다운로드한 **parameters.json** 파일을 업로드한 다음 변경 내용을 저장합니다.

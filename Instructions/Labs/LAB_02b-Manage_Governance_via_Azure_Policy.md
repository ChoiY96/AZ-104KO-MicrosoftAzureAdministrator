...
1. **신규** 블레이드에서 **Storage 을** 검색하여 선택하고 **만들기**를 클릭합니다. 
...
1. **신규** 블레이드에서 **Storage 계정**를 검색하여 선택하고 **만들기**를 클릭합니다. 
...
1. 스토리지 계정 목록에서 이 랩의 마지막 작업에서 만든 스토리지 계정에 해당하는 리소스 그룹을 선택합니다. **태그**를 선택하고 **Role:Infra** 태그로 **삭제를** 클릭(우측 휴지통)한 후 **저장**을 누릅니다.

1. 포털에서 다시 한 번 **스토리지 계정**을 검색하고 선택하거나 상단 메뉴를 사용하여 **스토리지 계정**을 선택합니다.
